...
- (void)commonInit{
    ...
    [self bringSubviewToFront:trackView_];
...
- (void)setTabbarItems:(NSArray *)tabbarItems{
    if (_tabbarItems != tabbarItems) {
        ...
        CGFloat width = self.bounds.size.width/tabbarItems.count;
...
- (void)layoutTabbar{
    ...
    CGFloat trackX = width*self.selectedIndex;
...
- (void)setSelectedIndex:(NSInteger)selectedIndex{
    if (_selectedIndex != selectedIndex) {
        ...
        CGFloat width = self.bounds.size.width/self.tabbarItems.count;
        CGFloat trackX = width*selectedIndex;
        trackView_.frame = CGRectMake(trackX, trackView_.frame.origin.y, CGRectGetWidth(trackView_.bounds), CGRectGetHeight(trackView_.bounds));
